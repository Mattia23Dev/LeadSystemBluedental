...
const Lead = require('../models/lead');
  ...
  exports.getLeadsManualBase = async (req, res) => {
    ...
    try {
      ...
      }).select('data nome cognome numeroTelefono esito appDate recallHours recallDate priorità lastModify campagna utmCampaign utmContent summary tentativiChiamata città appVoiceBot punteggio nexus_sync')
      .populate({
        path: 'orientatori',
      })
